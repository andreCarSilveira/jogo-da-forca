...
const categorias = {
    jogos: ["valorant", "lol", "fortnite", "gta"],
    musica: ["guitarra", "piano", "bateria", "violino"],
    carros: ["ram", "gol", "elantra", "camaro"],
    flores: ["tulipa", "orquídea", "rosa", "anturio"],
    memes: ["papaco", "galocego", "canetaazul", "laele"]
}
